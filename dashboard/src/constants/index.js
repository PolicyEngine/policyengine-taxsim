...
export const OUTPUT_VARIABLES = [
  ...
  { code: 'srate', name: 'State marginal rate', policyengine: 'state_income_tax (marginal)' },
  ...
  { code: 'frate', name: 'Federal marginal rate', policyengine: 'income_tax (marginal)' },
  { code: 'ficar', name: 'FICA rate', policyengine: 'employee_payroll_tax (marginal)' },
];
