...
def compute_srebate_single(simulation, year):
    ...
    try:
        twin = Simulation(
            situation=simulation.situation_input,
            tax_benefit_system=scorp_tax_benefit_system(),
        )
...
def export_household(taxsim_input, policyengine_situation, logs, disable_salt):
    ...
    simulation = Simulation(
        situation=policyengine_situation, tax_benefit_system=scorp_tax_benefit_system()
    )
